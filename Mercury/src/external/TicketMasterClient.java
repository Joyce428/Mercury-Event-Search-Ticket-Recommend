...
public class TicketMasterClient {
	...
	private static final String API_KEY = "jkphG68KygWYUZGowyVA1bKOG56CE0ir";
	...
	public List<Item> search(double lat, double lon, String keyword){
		...
		String query = String.format("apikey=%s&latlong=%s,%s&", API_KEY,lat,lon,keyword, DEFAULT_RADIUS);
		...
		try {
			JSONObject obj = new JSONObject(responseBody.toString());//links, embeded(events--array item object), page 
